...
import { Globe, Cpu, MessageCircle, Database, Loader, User, Crown, Search, Wifi, BarChart3 } from 'lucide-react';
...
import SatelliteLayer from './components/Earth3D/SatelliteLayer';
import ConnectivityLayer from './components/Earth3D/ConnectivityLayer';
...
function App() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-surface-deep via-surface-mid to-surface-light flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="space-y-2 mb-4">
            ...
            <p className="text-sm text-accent-neural">📡 Loading Google Earth imagery...</p>
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Canvas camera={{ position: [0, 0, 10], fov: 75 }}>
          ...
          <EnhancedEarth 
            ...
            showSatelliteLayer={cloudsVisible}
          ...
          {/* Satellite layer */}
          <SatelliteLayer visible={satellitesVisible} />
          
          {/* Enhanced Connectivity layer */}
          <ConnectivityLayer visible={connectivityVisible} />
      ...
      {/* Enhanced Google Earth Style Controls */}
      <GoogleEarthControls
      ...
      >
        ...
        <p className="text-xl text-surface-air mb-8 leading-relaxed">
          Search any location by name, zoom in for incredible detail, and connect with AI consciousness powered by real-time data and connectivity analytics.
        </p>
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <button 
              className="neural-button"
              onClick={() => handleLocationSelect([-122.4194, 37.7749], "San Francisco")}
            >
          ...
          <div className="text-sm text-gray-400">
            🛰️ Real-time Google Earth integration • 🤖 AI location consciousness • 📱 Telefonica connectivity data • 📊 Advanced analytics dashboard
          </div>
        </div>
      </motion.div>
