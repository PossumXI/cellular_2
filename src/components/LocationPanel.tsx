      ...
      >
        <div className="location-cell h-full flex flex-col" style={{ minHeight: '600px' }}>
              ...
              <div style={{ minHeight: '180px' }}>
                ...
                <div className="space-y-3">
                  <textarea
                    ...
                    style={{ minHeight: '80px', color: '#1a1a1a !important' }}
                  />
                  <button
          ...
          <div className="flex-shrink-0 mt-6 space-y-3 p-4 bg-surface-deep/95 backdrop-blur-sm rounded-b-2xl border-t border-surface-light">
            ...
            <button className="w-full bg-transparent border border-accent-neural text-accent-neural rounded-full py-3 px-6 font-medium hover:bg-accent-neural hover:text-white transition-colors">
