...
export class RealtimeDataService {
  private newsApiKey = config.newsapi.apiKey;
  private weatherApiKey = config.openweather.apiKey;
  private googleApiKey = config.google.mapsApiKey;
  ...
  private async getWeatherData(lat: number, lng: number): Promise<WeatherData> {
    if (this.weatherApiKey === 'demo_key' || this.weatherApiKey === 'dc199c11deb0066da5fb66100aa5fff6') {
