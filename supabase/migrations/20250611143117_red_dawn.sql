...
-- Create views - FIXED to avoid point type in GROUP BY
...
GROUP BY location_name, ST_X(coordinates), ST_Y(coordinates)
...
GROUP BY location_name, ST_X(coordinates), ST_Y(coordinates), network_type
...
BEGIN
  ...
  SELECT EXTRACT(HOUR FROM NOW())::integer INTO v_hour;
...
INSERT INTO event_correlation_data (
  ...
  network_usage_increase,
  estimated_attendance
) VALUES 
  ('New Year''s Day', 'holiday', '2025-01-01', 'Global', point(0, 0), 85, 42, 1000000),
  ('Valentine''s Day', 'holiday', '2025-02-14', 'Global', point(0, 0), 65, 38, 500000),
  ('Independence Day', 'holiday', '2025-07-04', 'United States', point(-98.5795, 39.8283), 72, 45, 2000000),
  ('Christmas Day', 'holiday', '2025-12-25', 'Global', point(0, 0), 90, 55, 2000000),
  ('Thanksgiving', 'holiday', '2025-11-27', 'United States', point(-98.5795, 39.8283), 75, 40, 1500000)
