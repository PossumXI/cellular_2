...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE tablename = 'social_engagement_analytics' 
        AND policyname = 'Anyone can view social engagement analytics'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'social_engagement_analytics' 
        AND policyname = 'Anyone can insert social engagement analytics'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'network_performance_analytics' 
        AND policyname = 'Anyone can view network performance analytics'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'network_performance_analytics' 
        AND policyname = 'Anyone can insert network performance analytics'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'location_activity_heatmap' 
        AND policyname = 'Anyone can view location activity heatmap'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'location_activity_heatmap' 
        AND policyname = 'Anyone can insert location activity heatmap'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'location_activity_heatmap' 
        AND policyname = 'Anyone can update location activity heatmap'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'ai_interaction_analytics' 
        AND policyname = 'Users can view own AI interactions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'ai_interaction_analytics' 
        AND policyname = 'Anyone can insert AI interactions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'monetization_insights' 
        AND policyname = 'Authenticated users can view monetization insights'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'monetization_insights' 
        AND policyname = 'Anyone can insert monetization insights'
    ) THEN
        CREATE POLICY "Anyone can insert monetization insights" ON monetization_insights
            FOR INSERT TO public WITH CHECK (true);
    END IF;

    -- Event correlation data policies
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'event_correlation_data' 
        AND policyname = 'Anyone can view event correlation data'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'event_correlation_data' 
        AND policyname = 'Anyone can insert event correlation data'
    ) THEN
...
-- Create Views for Analytics (fixed to avoid array_agg with unnest)
...
SELECT 
    ...
    array_to_string(array_agg(trending_hashtags), ',') as trending_hashtags_text,
...
-- Insert some initial sample data for testing (only if tables are empty)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM social_engagement_analytics LIMIT 1) THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM network_performance_analytics LIMIT 1) THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM location_activity_heatmap LIMIT 1) THEN
        INSERT INTO location_activity_heatmap (
...
-- Generate initial monetization insights if none exist
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM monetization_insights LIMIT 1) THEN
        PERFORM generate_monetization_insights('social_trends', 'social_media', 'daily');
        PERFORM generate_monetization_insights('network_performance', 'telecom', 'daily');
        PERFORM generate_monetization_insights('ai_usage', 'ai_companies', 'daily');
        PERFORM generate_monetization_insights('location_popularity', 'real_estate', 'daily');
    END IF;
END
$$;